...
This course is the direct following of the previous one on [how to create a questionnaire using neuropsydia](https://github.com/neuropsychology/Courses/blob/master/Programing/Python/Neuropsydia/1.1.Computerize_Questionnaire.md). Now that we've created the skeleton containing the questions, we can customize it and add some parameters.
