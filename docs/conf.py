...
project = u'Courses'
copyright = u'2016, École de Neuropsychologie'
author = u'École de Neuropsychologie'
...
html_theme = 'default'  # default, bootstrap
...
#html_theme_path = sphinx_bootstrap_theme.get_html_theme_path()  # comment if default
